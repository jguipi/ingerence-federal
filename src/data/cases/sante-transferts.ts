...
export const santeTransferts: Case = {
  ...
  funding: [
    {
      ...
      paid: cad(null, ['accord-sante-qc', 'comptes-publics-sante-2025'], 'Part QC non ventilée. Total P/T « Priorités partagées » versé (Comptes publics 2025, national, toutes provinces) : 2 550 M$ en 2024-25, 2 500 M$ en 2023-24.'),
    ...
    },
    {
      ...
      conditional: cad(null, ['accord-sante-qc']),
      paid: cad(null, ['accord-sante-qc', 'comptes-publics-sante-2025'], 'Part QC non ventilée. Total P/T « soutien à domicile et santé mentale » versé (Comptes publics 2025, national) : 1 800 M$ en 2024-25 comme en 2023-24.'),
      remaining: cad(null, ['accord-sante-qc']),
      conditional_flag: true,
      conditionIds: ['sante-priorites', 'sante-reddition'],
      sourceIds: ['accord-sante-qc'],
  ...
  sourceIds: ['accord-sante-qc', 'comite-consultatif-qc', 'comptes-publics-sante-2025'],
